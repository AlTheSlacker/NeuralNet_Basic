...
public class Neuron
{
    ...
    private List<Synapse> outputSynapses = new List<Synapse>();
    ...
    public List<Synapse> OutputSynapses { get => outputSynapses; }
    public List<Synapse> InputSynapses { get => inputSynapses; }

    public Neuron(AFType aF) => activationFunction = aF;
    public void AddOutputSynapse(Synapse synapse) => outputSynapses.Add(synapse);
    public void AddInputSynapse(Synapse synapse) => inputSynapses.Add(synapse);
    ...
    public void SynapseFeedforward(Synapse synapse) => synapse.Activate();
