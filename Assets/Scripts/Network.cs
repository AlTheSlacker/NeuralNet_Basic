...
public class Network
{
    ...
    private List<Synapse> synapsesAll = new List<Synapse>();

    public Network(int inputs, int[] hiddenLayers, AFType[] afFunctions, int outputs, bool[] addBias, double learningRate)
    {
    ...
    public Synapse SynapseFind(int layer, int inputNeuron, int outputNeuron)
    {
    ...
    {
        Synapse synapse = SynapseFind(layer, inpNeuron, outNeuron);
